/**
 * Equinor override of CreateUpdateConfirmation.
 * Adds mandatory checklist validation (NGE-121879) when the user selects
 * "Final Confirmation" via the Add Confirmation flow.
 */
...
import lamIsEnabled from '../../../../../SAPAssetManager/Rules/LAM/LAMIsEnabled';
import IsNotCompleteAction from '../../../../../SAPAssetManager/Rules/WorkOrders/Complete/IsNotCompleteAction';
...
import GetPostingDate from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetPostingDate';
import GetDate from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetDate';
import GetStartTime from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetStartTime';
import GetStartTimeStamp from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetStartTimeStamp';
import GetEndDate from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetEndDate';
import GetEndTime from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetEndTime';
import GetCreatedDate from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetCreatedDate';
import GetCreatedTime from '../../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GetCreatedTime';
import TimeSheetGetPersonnelNumber from '../../../../../SAPAssetManager/Rules/TimeSheets/CreateUpdate/TimeSheetGetPersonnelNumber';
...
export default async function CreateUpdateConfirmation(context) {
    ...
    if (isFinalConfirmation) {
        ...
        // Equinor NGE-121879: Validate mandatory checklist items before allowing
        // final confirmation via the Add Confirmation flow.
        const checklistIncomplete = await validateMandatoryChecklist(context, args.WorkOrderId, args.OperationId);
        if (checklistIncomplete) {
            const message = context.localizeText('mandatory_checklist_incomplete_message');
            libCom.executeInlineControlError(context, libCom.getControlProxy(context,'IsFinalConfirmation'), message);
            return '';
        }
    }
