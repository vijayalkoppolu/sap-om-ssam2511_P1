...
export default async function NotificationUpdateMalfunctionEndOnPageLoad(context) {
    ...
    // Equinor: Operational Effect should always be read-only on update-notification-from-completion page
    formCellContainer.getControl('EffectListPicker').setEditable(false);
