...
/**
 * Equinor override: Removed Priority from NotificationHistory creation properties
 * to prevent Priority from being passed from SSAM to S/4.
 */
            ...
            return context.executeAction({
                ...
                'Properties': {
                    'Properties': {
                       ...
                       // Equinor: Removed 'Priority': createdNotif.Priority to prevent Priority from being sent to S/4
