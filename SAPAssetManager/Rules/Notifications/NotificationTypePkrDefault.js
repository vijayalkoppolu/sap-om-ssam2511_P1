...
export default function NotificationTypeLstPkrDefault(context, bindingObject) {
    ...
    if (bindingObject?.['@odata.type'] === '#sap_mobile.InspectionCharacteristic' && bindingObject?.InspectionLot_Nav?.WOHeader_Nav?.OrderType && bindingObject?.InspectionLot_Nav?.WOHeader_Nav?.PlanningPlant) {
