...
export default function FLPackContainerUpdateSuccess(context) {
const page = CommonLibrary.getPageName(context);

    const onSuccessAction = (page === 'EditPackContainer') ? '/SAPAssetManager/Rules/FL/BulkUpdate/BulkUpdateClosePage.js' : '';
