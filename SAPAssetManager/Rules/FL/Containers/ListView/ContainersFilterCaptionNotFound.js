import { CONTAINERS_NOTFOUND_FILTER } from './ContainersListQueryOptions';
...
export default async function ContainersFilterCaptionNotFound(context) {

      let baseFilter = `(${CONTAINERS_NOTFOUND_FILTER})`;
      try {
