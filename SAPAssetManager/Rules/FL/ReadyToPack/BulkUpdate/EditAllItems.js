...
export default function EditAllItems(clientAPI) {
    ...
    libCom.setStateVariable(clientAPI, 'SelectedRdyToPckItems', selectedItems);
    return clientAPI.executeAction('/SAPAssetManager/Actions/FL/ReadyToPack/FLRdyToPckBulkEditNav.action');
}
