...
export function GetEDTColumns(config) {
    let columns = [
        ...
        {
            'HeaderName': 'Quantity',
            'PreferredWidth': config.ItemFLEDTColWidth.qty,
        },
        {
            'HeaderName': 'UOM',
            'PreferredWidth': config.ItemFLEDTColWidth.uom,
        },
        {
            'HeaderName': 'StorageLocation',
            'PreferredWidth': config.ItemFLEDTColWidth.sloc,
        },
        {
...
export function GetPickQtyEDTColumns(config) {
    let columns = [
        {
            'HeaderName': 'ItemSelection',
        ...
        {
            'HeaderName': 'LoadingQuantity',
            'PreferredWidth': config.ItemEDTColWidth.qty,
        },
        {
            'HeaderName': 'ReceivingPointListPkr',
    ...
    let items =
        [
            ...
            },
            {
                ...
                'Property': 'EntryQty',
                'Parameters': {
                    'Value': '/SAPAssetManager/Rules/FL/ReturnsByProduct/BulkUpdate/GetEntryQty.js',
                },
            },
            {
                'Type': 'ListPicker',
                'Name': 'ReturnableQuantityUOMLstPkr',
                'IsMandatory': true,
                'IsReadOnly': false,
                'Property': 'RetblQtyOrderUnit',
                'Parameters': {
                    'Search': {
                        'Enabled': true,
                        'Delay': 500,
                    ...
                    'PickerItems': {
                        ...
                        'Target': {
                            ...
                            'Service': '/SAPAssetManager/Services/AssetManager.service',
                            'QueryOptions': '/SAPAssetManager/Rules/FL/Common/UOMListPickerQueryOptions.js',
                        },
                    },
                },
            },
            {
                'Type': 'ListPicker',
                'Name': 'RecommActionLstPkr',
                'IsMandatory': true,
                'IsReadOnly': false,
                'Property': 'FldLogsRecommendedAction',
                'Parameters': {
                    'Search': {
                        'Enabled': true,
                        'Delay': 500,
                    ...
                    'ItemsPerPage': 21,
                    'CachedItemsToLoad': 2,
                    'Caption': '/SAPAssetManager/Rules/FL/ReturnsByProduct/FormatLabelRecommendedActionsListPkr.js',
                    'Value': '{FldLogsRecommendedAction}',
                    'PickerItems': '/SAPAssetManager/Rules/FL/ReturnsByProduct/RecommendedActionPickerItems.js',
                },
            },
            {
                'Type': 'Button',
                ...
                'Parameters': {
                    ...
                    'Action': '/SAPAssetManager/Rules/FL/ReturnsByProduct/BulkUpdate/BulkFLPProductNav.js',
                    'Style': 'Secondary',
                },
            },
        ];
...
export function GetPickQtyEDTItems() {
    let items =
        [
        {
            'Type': 'Switch',
        ...
        },
        {
            ...
            'IsMandatory': true,
            'IsReadOnly': false,
            'Property': 'LoadingQtyInOrderUnit',
            'OnValueChange': '',
            'Parameters': {
                'Value': '/SAPAssetManager/Rules/FL/ReturnsByProduct/BulkUpdate/GetPickQty.js',
            },
        },
        {
            'Type': 'ListPicker',
            ...
            'Parameters': {
                ...
                'ItemsPerPage': 21,
                'CachedItemsToLoad': 2,
                'Caption': '/SAPAssetManager/Rules/FL/ReturnsByProduct/FormatLabelReceivingPoint.js',
                ...
                'PickerItems': {
                    ...
                    'Target': {
                        ...
                        'Service': '/SAPAssetManager/Services/AssetManager.service',
                        'QueryOptions': '/SAPAssetManager/Rules/FL/Common/ReceivingPointLstPkrQueryOptions.js',
                    },
                },
            },
        },
