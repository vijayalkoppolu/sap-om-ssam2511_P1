...
export default function ConfirmationOverviewRowsQuery(context) {
    ...
    return `$filter=(PostingDate le ${odataFirstDate.queryString(context, 'date')} and PostingDate ge ${odataLastDate.queryString(context, 'date')} or sap.hasPendingChanges())&$orderby=PostingDate desc`;
}
