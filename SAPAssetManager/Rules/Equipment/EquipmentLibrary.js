...
import FormatEquipType from '../FunctionalLocation/FormatEquipType';
...
export class EquipmentLibrary {
     ...
     * @param context The PageProxy object.
     */
    static async equipmentDetailViewFormat(context) {
        ...
        if (section === 'EquipmentObjectHeaderSection') {
            switch (property) {
                ...
                case 'Subhead':
                    ...
                    if (value) {
                        const description  = await FormatEquipType(context, equipment);
                        value = `${value}${description && description !== '-' ? ' - ' + description : ''}`;
                    }
