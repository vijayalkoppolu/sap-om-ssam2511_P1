...
import { STATUS_FAST_FILTERS } from '../FastFiltersWithStatuses';

export class S4ServiceQuotationItemsFastFilters extends FastFiltersWithStatuses {
    constructor(context) {
        const config = {
            statusPropertyPath: 'MobileStatus_Nav/MobileStatus',
        };
        super(context, 'ServiceQuotationItemsFilterPage', 'S4ServiceQuotationItems', config);
