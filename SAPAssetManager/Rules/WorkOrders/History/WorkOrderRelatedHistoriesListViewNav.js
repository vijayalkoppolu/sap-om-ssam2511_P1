...
export default function WorkOrderRelatedHistoriesListViewNav(sectionProxy) {
    ...
    if (odataType === '#sap_mobile.MyWorkOrderHeader') {
        return libCommon.navigateOnRead(sectionProxy.getPageProxy(), 
            '/SAPAssetManager/Rules/WorkOrders/WorkOrderRelatedHistoriesListViewNav.js', 
        ...
        return sectionProxy.getPageProxy().executeAction('/SAPAssetManager/Rules/WorkOrders/WorkOrderRelatedHistoriesListViewNav.js');
    }
}
