...
export default function WorkOrderOperationListViewFilter(context) {
    ...
    if (libCom.isDefined(context.binding['@odata.readLink']) && context.binding['@odata.readLink'].split('(')[0] === 'MyWorkOrderHeaders') {
    ...
    } else if (IsOperationLevelAssigmentType(context) || libPersona.isWCMOperator(context)) {
