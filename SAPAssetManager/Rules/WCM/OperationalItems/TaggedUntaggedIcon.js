...
function GetOperationalItemTaggedIcon(wcmDocumentItem) {
    return {
        ...
        [OpItemMobileStatusCodes.UntagTemporarily]: 'StatusTempLocked',
        [OpItemMobileStatusCodes.TestTagPrinted]: 'StatusTempLocked',
        [OpItemMobileStatusCodes.TemporaryUntagged]: 'StatusTempUnlocked',
