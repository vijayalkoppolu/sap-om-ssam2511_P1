...
export default function MeasurementDocumentMeasurementDocNumWithChangeSetIncrement(context) {
    ...
    return GenerateLocalIDWithChangeSetIncrement(context, 'MeasurementDocuments', 'MeasurementDocNum', '000000000000', 'LOCAL_M', 'SortField', increment, "$filter=startswith(MeasurementDocNum, 'LOCAL') eq true");
}
