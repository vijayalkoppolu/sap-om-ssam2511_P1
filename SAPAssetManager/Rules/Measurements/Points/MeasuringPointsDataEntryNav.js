...
export default function MeasuringPointsDataEntryNav(context) {
    ...
    const sectionData = [{
        ...
        {
            'Caption': '/SAPAssetManager/Rules/Measurements/Points/MeasuringPointDescriptionCaptionFDC.js',
            '_Name': 'ReadingSim',
        ...
        },
        {
            ...
            'Caption': '/SAPAssetManager/Rules/Measurements/Points/MeasuringPointValuationCodeCaptionFDC.js',
            'OnValueChange': '/SAPAssetManager/Rules/Common/Validation/ResetValidationOnInput.js',
            'PickerItems': {
                'DisplayValue': '/SAPAssetManager/Rules/Measurements/DisplayValueValuationCode.js',
                'ReturnValue': '{@odata.readLink}',
        ...
        },
        {
            ...
            'IsEditable': '/SAPAssetManager/Rules/LAM/LAMAllowEditForLRPFields.js',
            'IsVisible': '/SAPAssetManager/Rules/LAM/LAMIsEnabledMeasuringPoint.js',
