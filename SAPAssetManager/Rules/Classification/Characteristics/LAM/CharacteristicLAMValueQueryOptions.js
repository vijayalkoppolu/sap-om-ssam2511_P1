...
export default function CharacteristicLAMValueQueryOptions(context) {
    ...
    let query = '$filter=(ObjectKey eq \'' + objKey + '\' and InternCharacteristic eq \'' + charId + '\' and Table eq \'' + objType + '\')&$expand=' + expand+'&$orderby=LAMInternCounter desc,'+expand+'/CharValDesc asc,'+expand+'/CharValFrom asc';
    return query;
}
