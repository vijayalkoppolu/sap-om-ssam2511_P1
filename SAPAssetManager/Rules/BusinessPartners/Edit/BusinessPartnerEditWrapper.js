    ...
    editAddressActionData() {
        ...
        switch (this.partnerType) {
            ...
            case 'KU': //For vendor and customer, the address info is in the Address_Nav EntitySet
                ...
                break;
            case 'S4':
                clientData.addressEntity = 'S4ServiceOrderPartners';
                //Seperate entity set for S4ServiceRequestPartners
                if (this.entity['@odata.type'] === '#sap_mobile.S4ServiceRequestPartner') {
                    clientData.addressEntity = 'S4ServiceRequestPartners';
                }
                action = '/SAPAssetManager/Actions/BusinessPartners/S4/S4BusinessPartnersEditAddress.action';
                break;
            case 'AP':
        ...
        if (entity != null) {
            switch (this.partnerType) {
                ...
                case 'KU': //For vendor and customer, the address info is in the Address_Nav EntitySet
                    ...
                    break;
                case 'S4':
                    clientData.addressComm = 'S4ServiceOrderPartners';
                    //Seperate entity set for S4ServiceRequestPartners
                    if (this.entity['@odata.type'] === '#sap_mobile.S4ServiceRequestPartner') {
                        clientData.addressComm = 'S4ServiceRequestPartners';
                    }
                    action = '/SAPAssetManager/Actions/BusinessPartners/S4/S4BusinessPartnersEditAddressComm.action';
                    break;
                case 'AP':
                case 'US': //For contact and user, the AddressAtWork_Nav EntitySet
