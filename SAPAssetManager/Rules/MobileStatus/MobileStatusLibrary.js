...
export default class {
    ...
    static setStartStatus(context, binding = libCommon.getBindingObject(context)) {
        ...
        libThis.setMobileStatus(binding, clientData.ChangeStatus, libCommon.getUserGuid(context), libCommon.getSapUserName(context));
    }

    static setHoldStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setAcceptedStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setTravelStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setOnsiteStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setTransferStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setCompleteStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setSuccessStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setReviewStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setRejectedStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setDisapprovedStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
    ...
    static setApprovedStatus(context, binding = libCommon.getBindingObject(context)) {
        let clientData = context.getClientData();
     ...
     * @param {*} status
     */
    static setGenericStatus(context, status, binding) {
        let clientData = context.getClientData();
     ...
     * @param {*} status
     */
    static phaseModelStatusChange(context, status, binding = libCommon.getBindingObject(context)) {
        switch (status) {
            case 'COMPLETED':
                return libThis.setCompleteStatus(context, binding);
            case 'HOLD':
                return libThis.setHoldStatus(context, binding);
            case 'REJECTED':
                return libThis.setRejectedStatus(context, binding);
            case 'REVIEW':
                return libThis.setReviewStatus(context, binding);
            case 'STARTED':
                return libThis.setStartStatus(context, binding);
            case 'SUCCESS':
                return libThis.setSuccessStatus(context, binding);
            case 'TRANSFER':
                return libThis.setTransferStatus(context, binding);
            case 'DISAPPROVE':
                return libThis.setDisapprovedStatus(context, binding);
            case 'APPROVE':
                return libThis.setApprovedStatus(context, binding);
            default:
                return libThis.setGenericStatus(context, status, binding);
        }
    }
    ...
    static markedJobsListMobileStatus(context, binding) {
        let isLocal = ODataLibrary.isLocal(binding.WorkOrderHeader);
        let status = '';
        if (!isLocal) {
        ...
        if (binding) {
            ...
            switch (binding['@odata.type']) {
                ...
                case '#sap_mobile.MyWorkOrderOperationCapacityRequirement':
                    if (binding.PMMobileStatus_Nav.MobileStatus) {
                        return binding.PMMobileStatus_Nav.MobileStatus;
                    }
                    break;
                default:
    ...
    static getMobileStatusNavLink(context, binding = context.binding) {
        if (binding) {
            switch (binding['@odata.type']) {
                ...
                case '#sap_mobile.MyWorkOrderOperationCapacityRequirement':
                        return binding.PMMobileStatus_Nav;
                case '#sap_mobile.MyWorkOrderSubOperation':
    ...
    static setMobileStatus(binding, mobileStatus, userGUID, userId) {
        if (binding && mobileStatus && (mobileStatus !== '')) {
            switch (binding['@odata.type']) {
                ...
                case '#sap.mobile.MyWorkOrderOperationCapacityRequirement': {
                    binding.PMMobileStatus_Nav.MobileStatus = mobileStatus;
                    binding.PMMobileStatus_Nav.CreateUserGUID = userGUID;
                    binding.PMMobileStatus_Nav.CreateUserId = userId;
                    break;
                }
                default:
            }
    ...
    */
    ...
    static getObjectTypesForCurrentAssignmentLevel(context) {
        const objectTypes = [];
        objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/Notification.global').getValue());
        objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/Task.global').getValue());

        if (IsS4ServiceIntegrationEnabled(context)) {
            objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/S4Service/RequestMobileStatusObjectType.global').getValue());
            switch (libCommon.getS4AssnTypeLevel(context)) {
                case 'Header':
                    objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/S4Service/OrderMobileStatusObjectType.global').getValue());
                    break;
                case 'Item':
                    objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/S4Service/ItemMobileStatusObjectType.global').getValue());
                    break;
                default:
                    break;
            }
        ...
        switch (libCommon.getWorkOrderAssnTypeLevel(context)) {
            case 'Header':
                objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/WorkOrder.global').getValue());
                break;
            case 'Operation':
                objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/WorkOrderOperation.global').getValue());
                objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/WorkOrderOperationCapacity.global').getValue());
                break;
            case 'SubOperation':
                objectTypes.push(context.getGlobalDefinition('/SAPAssetManager/Globals/ObjectTypes/WorkOrderOperation.global').getValue());
                break;
