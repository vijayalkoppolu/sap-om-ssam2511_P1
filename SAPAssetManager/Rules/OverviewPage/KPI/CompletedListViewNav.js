...
/**
 * Navigate to the correct list view after pressing Completed KPI on new overview screen for maintenance technician
 * First set the state variable for the default filter to apply on the list page
 * @param {*} context 
 * @returns 
 */
export default function CompletedListViewNav(context) {
