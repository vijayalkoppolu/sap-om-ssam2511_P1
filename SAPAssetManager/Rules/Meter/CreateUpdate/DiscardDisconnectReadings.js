...
function deleteReadings(context) {
    return context.read('/SAPAssetManager/Services/AssetManager.service', context.binding['@odata.readLink'] + '/Device_Nav/MeterReadings_Nav', [], '$expand=Device_Nav&$filter=sap.hasPendingChanges()').then(function(result) {
