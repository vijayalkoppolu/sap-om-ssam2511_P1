export default function SetMaterialDocumentListRecentTitle(context) {
    return context.count('/SAPAssetManager/Services/AssetManager.service', 'MaterialDocuments', '$filter=sap.hasPendingChanges()&$orderby=MaterialDocNumber').then(function(result) {
