...
export default function TimeSheetEntryCreateWOEntitySet(context) {
    ...
    } else if (odataType === '#sap_mobile.MyWorkOrderOperationCapacityRequirement') {
        return [{DisplayValue: libForm.formatListPickerDisplayValue(context,binding.MyWorkOrderOperation_Nav.WOHeader.OrderId,binding.MyWorkOrderOperation_Nav.WOHeader.OrderDescription), ReturnValue: binding.MyWorkOrderOperation_Nav.WOHeader['@odata.readLink']}];
