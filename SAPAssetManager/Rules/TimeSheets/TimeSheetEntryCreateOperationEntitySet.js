...
export default function TimeSheetEntryCreateOperationEntitySet(context) {
    ...
    if (odataType === '#sap_mobile.MyWorkOrderOperation') {
        ...
        returnValue.push({DisplayValue: libForm.formatListPickerDisplayValue(context,binding.MyWorkOrderOperation_Nav.OperationNo,binding.MyWorkOrderOperation_Nav.OperationShortText), ReturnValue: binding.MyWorkOrderOperation_Nav['@odata.readLink']});
        return returnValue;
